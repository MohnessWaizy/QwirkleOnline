...
\newcommand{\authordetailsblock}{
	...
	\parbox[t]{0.53\textwidth}{ % Box holding the author details; width value specifies where it starts and ends, increase to move details left
...
\renewcommand{\opening}[1]{
	...
	\hspace*{\longindentation}{\footnotesize \underline{ahoiSoftware $\cdot$ Warburger Straße 100 $\cdot$ 33100 Paderborn}}\hspace*{\fill}\par} % Print today's date, remove \today to not display it
