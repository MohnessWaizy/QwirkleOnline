...
public class Configuration {
	...
	public boolean equals(Object o) {
		...
		return (getColorShapeCount() == that.getColorShapeCount()) && (getTileCount() == that.getTileCount())
				&& (getMaxHandTiles() == that.getMaxHandTiles()) && (getTurnTime() == that.getTurnTime())
				...
				&& (getMaxPlayerNumber() == that.getMaxPlayerNumber()) && (getWrongMove() == that.getWrongMove())
	...
	public String toString() {
		return "Configuration [colorShapeCount=" + colorShapeCount + ", tileCount=" + tileCount + ", maxHandTiles="
				...
				+ slowMovePenalty + ", maxPlayerNumber=" + maxPlayerNumber + "]";
	}
